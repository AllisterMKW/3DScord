...
void AboutScreen::renderTop(C3D_RenderTarget *target) {
	...
	drawCenteredRichText(centerY + 30.0f, 0.5f, 0.8f, 0.8f, ScreenManager::colorText(), "3DScord", 400.0f);
...
void AboutScreen::renderBottom(C3D_RenderTarget *target) {
	...
	y += 13.0f;
	drawRichText(x + 8.0f, y, 0.5f, 0.36f, 0.36f, ScreenManager::colorLink(), "https://github.com/2b-zipper/3DScord");
	...
	drawText(35.0f, 10.0f, 0.85f, 0.5f, 0.5f, ScreenManager::colorText(), "About 3DScord");
